...
get_header(); ?>
      ...
      <h2>PUROFORM PROJECT MANAGEMENT</h2>
		<?php the_field('puroform_project_management', 'options'); ?>
		</div>
...
<div class="cat">
    <div class="js-class">
	<?php query_posts( array( 'post_type' => 'project', 'cat' => 20, 'showposts' => 16 ) );
    ...
    <div class="html5" >
	<?php query_posts( array( 'post_type' => 'project', 'cat' => 19, 'showposts' => 16 ) );
		if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<?php $post_status = get_field('post_status'); ?>
			...
			<?php endwhile; endif; wp_reset_query(); ?>
				...
				<div class="project_choice">
					<a class="see_all_projects seemore" href="/category/puroform-boutique-development">PUROFORM BOUTIQUE DEVELOPMENT >></a>
				</div>
