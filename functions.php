...
register_nav_menus( array(
	...
	'header-menu-additional' => 'Header Menu Additional',
	'footer-menu' => 'Footer Menu',
	'footer-menu-additional' => 'Footer Menu Additional'
) );
...
function foundation_scripts_and_styles() {
	if ( ! is_admin() ) {
		...
		// wp_enqueue_script( 'masonry', get_template_directory_uri() . '/assets/js/plugins/masonry.pkgd.min.js', null, '4.2.2', true );
		wp_enqueue_script( 'isotope', get_template_directory_uri() . '/assets/js/plugins/isotope.pkgd.min.js', null, '3.0.6', true );
...
//Admin Style for Flexible Content
